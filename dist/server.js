...
app.use(express_1.default.static(path.join(__dirname, "./../../Erne-Legacy-Telegram-App-Frontend/dist")));
app.get("/*", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    res.sendFile(path.join(__dirname, "./../../Erne-Legacy-Telegram-App-Frontend/dist", "index.html"));
}));
// }
app.listen(port, () => {
